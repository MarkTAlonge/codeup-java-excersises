...
public class DishTools {
    public static final int AVERAGE_COST_OF_DISH_CENTS = 13000;
    ...
    public static void analyzeDishCost(Dish d) {
        String message = (d.getCostInCents() < AVERAGE_COST_OF_DISH_CENTS) ? "Less expensive than average" : "More expensive than average";
